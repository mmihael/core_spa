...
class UserForm extends Component {
  ...
  render() {
    return (
      <ApiForm
        entityUriRoot={ApiUris.USERS_URI}
        ...
        createSuccessRedirect={Routes.DASHBOARD_USERS_URI}
        updateSuccessRedirect={Routes.DASHBOARD_USERS_URI}
        cancelButtonRedirect={Routes.DASHBOARD_USERS_URI}
        elements={[
          ...
          { type: 'checkbox', propSelector: 'enabled', label: translate('Enabled'), inputId: 'enabled' },
          {
            ...
            loadOptions: new Promise((resolve, reject) => {
              ApiClient
                .getRolePage({ size: -1, organizationRole: false })
                .then(res => {
